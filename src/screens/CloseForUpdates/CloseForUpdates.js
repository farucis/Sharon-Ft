...
import "./CloseForUpdates.css";
const CloseForUpdates = () => {
  return (
    <section className="close-for-updates">
      <main>
        <div className="tower">
        ...
        <div className="message">
          <p className="message__line">…ממתין</p>
          <p className="message__line">…מחבר את החלקים</p>
          <p className="message__line">…חלק זה בשיפוצים</p>
          <p className="message__line">…אפשר לנסות במכשיר אחר</p>
          <p className="message__line">
          …ממתין
          </p>
          <p className="message__line">…מנסה שוב</p>
          <p className="message__line">
          …חלק זה בשיפוץ למכשיר זה
          </p>
          <p className="message__line">…נסה שוב מאוחר יותר</p>
        </div>
      </main>
    </section>
  );
...
export default CloseForUpdates;
